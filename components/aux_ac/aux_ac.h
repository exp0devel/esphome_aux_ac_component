...
#define HOLMES_CRC_BRACKET_CLOSE "]"
        ...
        // params
        const float Constants::AC_MIN_TEMPERATURE = esphome::ballu::YKR_K_002E_TEMP_MIN;
        const float Constants::AC_MAX_TEMPERATURE = esphome::ballu::YKR_K_002E_TEMP_MAX;
...
#define AC_POWER_MASK 0b00100000
        ...
        {
            AC_POWER_OFF = 0x00,
            AC_POWER_ON  = esphome::ballu::BALLU_POWER,
...
#define AC_MODE_MASK 0b11100000
        ...
        {
            AC_MODE_AUTO = esphome::ballu::BALLU_AUTO,
            AC_MODE_COOL = esphome::ballu::BALLU_COOL,
            AC_MODE_DRY  = esphome::ballu::BALLU_DRY,
            AC_MODE_HEAT = esphome::ballu::BALLU_HEAT,
            AC_MODE_FAN  = esphome::ballu::BALLU_FAN,
...
#define AC_LOUVERV_MASK esphome::ballu::BALLU_SWING_VER
...
#define AC_LOUVERH_MASK 0b11100000
        enum ac_louver_H : uint8_t
        {
            ...
            AC_LOUVERH_OFF_ALTERNATIVE = esphome::ballu::BALLU_SWING_HOR, // 0b11100000 - по коду везде кроме проверок использую его, так как у него все три бита в 1
...
#define AC_FANSPEED_MASK 0b11100000
        ...
        {
            AC_FANSPEED_HIGH   = esphome::ballu::BALLU_FAN_HIGH,
            AC_FANSPEED_MEDIUM = esphome::ballu::BALLU_FAN_MED,
            AC_FANSPEED_LOW    = esphome::ballu::BALLU_FAN_LOW,
            AC_FANSPEED_AUTO   = esphome::ballu::BALLU_FAN_AUTO,
